...
export const botConfig = {
 ...
 presence: {
  status: "online",
  activities: [
    { name: "{memberCount} active players | {activePlayers} active premium players", type: 0 },
  ],
},

// New section — wherever makes sense, e.g. near the bottom of botConfig
activeScript: {
  endpoint: process.env.ACTIVE_SCRIPT_ENDPOINT || "https://novahub-helper-production.up.railway.app",
},
